                    ...
                    <div class="card mb-2 p-1">
                      <div class="card-header border-0 px-0 py-1" id="heading-${tab.n_tab}">
                        <h2 class="card-tit mb-0 px-2">
                          <button id="${tab.tabId}" class="btn btn-link list-tit py-1 w-100" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-${tab.n_tab}" aria-expanded="true" aria-controls="collapse-${tab.n_tab}">T R A C K S</button>
                        </h2>
                      </div>
